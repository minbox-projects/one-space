...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app_store::projects_list,
            app_store::projects_get,
            app_store::projects_create,
            app_store::projects_update,
            app_store::projects_delete,
            app_store::project_attachments_import,
            app_store::chat_threads_list,
            app_store::chat_thread_get,
            app_store::chat_thread_create,
            app_store::chat_thread_delete,
            app_store::chat_messages_list,
            app_store::chat_stream_start,
            app_store::chat_stream_stop,
            app_store::chat_models_list,
            app_store::skills_preview,
            app_store::skills_execute,
