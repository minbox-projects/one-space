...
export function ModelListPanel({
  ...
  const providerOptions = useMemo(() => {
    ...
    const options = [
      {
        value: "all",
        label: t("apiGatewayModelListAllProviders", "All providers"),
      },
    ];
  ...
  const protocolOptions = useMemo(
    () => [
      {
        value: "all",
        label: t("apiGatewayModelListAllProtocols", "All protocols"),
      },
      {
  ...
  return (
    <div className="space-y-4" data-testid="api-gateway-model-list">
      {/* 头部区域：对齐模块规范，增强视觉层次 */}
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-0.5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-foreground">
              {t("apiGatewayModelListTab", "Model list")}
            </h3>
        ...
        {rows.length > 0 ? (
          <div className="text-xs text-muted-foreground">
            {t("apiGatewayModelListFilteredCount", {
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <div className="relative w-full sm:w-80 md:w-96">
            ...
            {query ? (
              <button
                type="button"
                onClick={() => setQuery("")}
                aria-label={t("apiGatewayModelListClearSearch", "Clear search")}
          ...
          {providerOptions.length > 2 ? (
            <SelectDropdown
              ...
              ariaLabel={t(
                "apiGatewayModelListFilterProvider",
                "Filter by provider",
              )}
              testId="api-gateway-model-list-provider-filter"
          ...
          <SelectDropdown
            ...
            ariaLabel={t(
              "apiGatewayModelListFilterProtocol",
              "Filter by protocol",
            )}
            testId="api-gateway-model-list-protocol-filter"
            buttonClassName="h-9 text-xs font-normal whitespace-nowrap shadow-xs"
            menuClassName="min-w-[150px] whitespace-nowrap"
          ...
          {hasActiveFilters ? (
            ...
            >
              <X className="h-3.5 w-3.5" />
              <span>
                {t("apiGatewayModelListClearFilters", "Clear filters")}
              </span>
            </button>
          ) : null}
        </div>
      ...
      {rows.length === 0 ? (
        ...
        >
          ...
          <p className="mt-1 max-w-sm text-[11px] text-muted-foreground">
            {t(
              "apiGatewayAggregatedModelsDialogDesc",
        ...
        >
          ...
          >
            <X className="h-3 w-3" />
            <span>{t("apiGatewayModelListClearFilters", "Clear filters")}</span>
          </button>
        </div>
      ) : (
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex flex-wrap items-center gap-1.5">
                          ...
                          {entry.providers.length > 1 ? (
                            <span
                              title={t("apiGatewayModelListMultiUpstreamBadge", {
                        ...
                        <button
                          type="button"
                          data-testid="api-gateway-model-list-copy-btn"
                          aria-label={t(
