  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        data-testid="api-gateway-aggregated-models"
      >
        ...
        {models.length === 0 ? (
          <p
            data-testid="api-gateway-aggregated-models-empty"
          ...
          <ul className="space-y-2">
            {models.map((row) => (
              <li
                key={row.model}
                data-testid="api-gateway-aggregated-model"
                ...
                <ul className="mt-2 space-y-1.5">
                  {row.providers.map((entry, index) => (
                    <li
                      ...
                      data-testid="api-gateway-aggregated-model-provider"
