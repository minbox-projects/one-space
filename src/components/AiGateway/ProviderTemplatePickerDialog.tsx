  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        data-testid="ai-gateway-template-picker-dialog"
      >
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <DialogTitle className="truncate text-base font-semibold leading-5 text-foreground">
                  {t(
                    "aiGatewayAddUpstreamProviderDialogTitle",
                    t("aiGatewaySelectProviderTemplate", "Add Upstream Provider"),
                  )}
                </DialogTitle>
                <DialogDescription className="text-xs text-muted-foreground mt-0.5 line-clamp-1">
                  {t(
                    "aiGatewaySelectProviderTemplateDesc",
          ...
          >
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-start gap-3.5 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  <div className="font-semibold text-sm text-foreground flex items-center gap-2">
                    <span>{t("aiGatewayBlankProviderPreset", "Create manually")}</span>
                    <span className="rounded-full bg-primary/15 px-2 py-0.2 text-[10px] font-medium text-primary">
                      {t("aiGatewayBlankProviderPresetQuick", "Manual")}
                    </span>
                  </div>
                  <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                    {t(
                      "aiGatewayBlankProviderPresetDesc",
              ...
              <div className="hidden sm:flex items-center gap-1 text-xs font-medium text-primary shrink-0 opacity-80 group-hover:opacity-100 group-hover:translate-x-0.5 transition">
                <span>{t("aiGatewayUseThisTemplate", "Configure")}</span>
          ...
          <div className="flex items-center justify-between pt-1 pb-0.5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-foreground">
                {t("aiGatewayPresetTemplatesSectionTitle", "Provider Templates")}
              </span>
            ...
            <span className="text-[11px] text-muted-foreground hidden sm:inline">
              {t("aiGatewayPresetTemplatesHint", "Select a template to import official models and protocol configurations")}
            </span>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 pt-1 text-xs text-muted-foreground">
                          ...
                          {template.source && (
                            <span className="font-mono text-[11px] break-all" title={template.source}>
                              {t("aiGatewayTemplateSource", "Source")}: {template.source}
                            </span>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="hidden sm:flex items-center gap-1 text-xs font-medium text-primary shrink-0 opacity-80 group-hover:opacity-100 group-hover:translate-x-0.5 transition">
                      <span>{t("aiGatewayUseThisTemplate", "Use template")}</span>
                      <ArrowRight className="h-3.5 w-3.5" />
                    </div>
                  </div>
                </button>
