...
export function ProviderTemplateEditDialog({
  ...
  const handleSubmit = async () => {
    ...
    if (!trimmedName) {
      setValidationError(t("aiGatewayTemplateNameLabel", "Name is required"));
      return;
    }
    const trimmedUrl = baseUrl.trim();
    if (!trimmedUrl) {
      setValidationError(
        t("aiGatewayTemplateBaseUrlLabel", "API base URL is required"),
      );
      return;
    }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        data-testid="ai-gateway-template-edit-dialog"
      >
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <DialogTitle className="truncate text-base font-semibold leading-5 text-foreground">
                  {isEditing
                    ? t("aiGatewayEditTemplate", "Edit template")
                    : t("aiGatewayNewTemplate", "New template")}
                </DialogTitle>
                {models.length > 0 ? (
        ...
        <div className="flex-1 overflow-y-auto space-y-4.5 p-6">
          ...
          <div className="field-grid col-2 mb-0">
            ...
            <div className="field">
              <label>{t("aiGatewayTemplateIconLabel", "Icon")}</label>
              <ProviderTemplateIconPicker
                value={icon}
                onChange={setIcon}
                templateId={id}
            ...
            <div className="field">
              <label className="required">
                {t("aiGatewayTemplateProtocolLabel", "Protocol")}
              </label>
              <select
                ...
                disabled={disabled}
                aria-label={t("aiGatewayTemplateProtocolLabel", "Protocol")}
              >
                <option value="chat_completions">
                  {t(
                    "aiGatewayProtocolChat",
            ...
            <div className="field">
              <label>{t("aiGatewayTemplateModelsUrl", "Models URL")}</label>
              <input
                type="text"
                ...
                disabled={disabled}
                placeholder={t(
                  "aiGatewayTemplateModelsUrlPlaceholder",
                  "e.g. https://api.openai.com/v1/models (optional)",
                )}
                className="font-mono"
                aria-label={t("aiGatewayTemplateModelsUrl", "Models URL")}
              />
            </div>
                      ...
                      >
                        ...
                        {isExpanded ? (
                          <>
                            ...
                            <div
                              data-testid={`ai-gateway-mapping-efforts-${idx}`}
                            ...
                            >
                              ...
                              {efforts.length > 0 ? (
                                <div className="flex flex-wrap items-center gap-1.5">
                                  {efforts.map((effort) => (
                                    <span
                                      key={effort}
                                      data-testid={`ai-gateway-mapping-effort-${idx}-${effort}`}
                                    ...
                                    >
                                      ...
                                      <button
                                        ...
                                        aria-label={t("aiGatewayRemoveEffortAria", {
                                          effort,
                              ...
                              <div className="flex items-center gap-2">
                                <input
                                  type="text"
                                  data-testid={`ai-gateway-mapping-effort-input-${idx}`}
                                ...
                                <button
                                  type="button"
                                  data-testid={`ai-gateway-mapping-effort-add-${idx}`}
                                  onClick={() => addEffort(idx)}
                                  aria-label={t("aiGatewayAddReasoningEffort", "Add")}
                                ...
                                >
                                  <Plus className="h-3 w-3" />
                                  {t("aiGatewayAddReasoningEffort", "Add")}
                                </button>
                              </div>
                            </div>
                          </>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  {confirmDelete
                    ...
                    : t("aiGatewayDeleteTemplate", "Delete template")}
                </button>
                {isUsed && (
                  <span
                    ...
                    title={t("aiGatewayTemplateInUseBy", {
                      name: usingProviders.map((p) => p.name).join(", "),
                    })}
                  >
