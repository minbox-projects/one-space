...
import type { GatewayKey } from "@/lib/aiGateway";
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent
        ...
        data-testid="ai-gateway-key-dialog"
      >
        ...
        <div className="space-y-4 py-2">
          <div className="field full-span">
            <label className="required">{t("aiGatewayKeyLabel", "Name")}</label>
            <input
              type="text"
              value={name}
              onChange={(event) => setName(event.target.value)}
              onKeyDown={handleKeyDown}
              placeholder={t("aiGatewayKeyLabelPlaceholder", "Key name")}
              aria-label={t("aiGatewayKeyLabel", "Name")}
