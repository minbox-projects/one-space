...
const resources = {
  en: {
    translation: {
      ...
      apiFusionConfigureSelected: "Configure selected",
      apiFusionSyncSelected: "Sync selected",
  ...
  zh: {
    translation: {
      ...
      apiFusionTerminalSyncDesc:
        "把本地 Api 地址与默认本地 Key 写入所选 OpenCode / Codex 记录，仅修改 base_url 与 api_key。",
      apiFusionConfigureSelected: "一键配置所选",
      apiFusionSyncSelected: "同步所选",
