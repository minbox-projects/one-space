    ...
    translation: {
      ...
      aiRoutingGateway: {
        ...
        home: {
          ...
          todayTokens: "Today's tokens", input: "Input", output: "Output", estimatedCost: "Estimated cost", costDisclaimer: "Public API equivalent estimate",
        ...
        accounts: {
          ...
          quotaOAuthOnly: "Quota windows apply to OAuth accounts only.", noQuota: "No quota snapshot yet.", stale: "Stale", mappings: "Model mappings",
        ...
        logs: {
          status: "Status", allStatuses: "All statuses", clear: "Clear details", clearConfirm: "Clear all request and attempt details? Daily aggregates will remain.", empty: "No request logs match these filters.",
          time: "Time", model: "Model", account: "Account", tokens: "Tokens", cost: "Cost", noError: "No error", noAttempts: "No upstream attempts recorded.",
        ...
        settings: {
          ...
          pricing: "Model pricing", pricingHint: "Prices are USD per million tokens. Missing prices keep cost explicitly non-calculable.", inputPrice: "Input price", outputPrice: "Output price", addPrice: "Add price snapshot",
    ...
    translation: {
      ...
      aiRoutingGateway: {
        ...
        home: {
          ...
          todayTokens: "今日 Token", input: "输入", output: "输出", estimatedCost: "预估费用", costDisclaimer: "公开 API 单价等效预估",
          trend: "每日趋势", tokens: "Token", cost: "费用", emptyTrend: "该时段暂无请求。",
        },
        accounts: {
          name: "账号名称", tags: "标签", threshold: "额度阈值（%）", inherit: "继承全局阈值", note: "备注", quota: "额度窗口",
          quotaOAuthOnly: "额度窗口仅适用于 OAuth 账号。", noQuota: "暂无额度快照。", stale: "已过期", mappings: "模型映射",
        ...
        logs: {
          status: "状态", allStatuses: "全部状态", clear: "清空明细", clearConfirm: "清空全部请求和 attempt 明细？每日聚合会保留。", empty: "没有符合筛选条件的请求日志。",
          time: "时间", model: "模型", account: "账号", tokens: "Token", cost: "费用", noError: "无错误", noAttempts: "没有记录上游 attempt。",
        ...
        settings: {
          ...
          pricing: "模型价格", pricingHint: "价格单位为美元/百万 Token；缺失价格会明确保持不可计算。", inputPrice: "输入价格", outputPrice: "输出价格", addPrice: "添加价格快照",
