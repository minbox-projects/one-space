  ...
  en: {
    translation: {
      ...
      aiRoutingGateway: {
        ...
        common: {
          loading: "Loading gateway data...", loadFailed: "Gateway data could not be loaded", retry: "Retry", refresh: "Refresh",
          empty: "No gateway data is available.", save: "Save", create: "Create", cancel: "Cancel", close: "Close", copy: "Copy",
          start: "Start gateway", stop: "Stop gateway", enabled: "Enabled", disabled: "Disabled", add: "Add", notCalculable: "N/A",
          days: "days", daysSuffix: "d",
        },
        states: {
          running: "Running", stopped: "Stopped", error: "Error", locked: "Credential store locked",
          stoppedHint: "The gateway is not accepting requests.", portConflict: "Port conflict",
          portConflictHint: "Port {{port}} is unavailable. Change the port in Settings before restarting.",
        },
        errors: {
        ...
        home: {
          accounts: "Account capacity", available: "available for routing", quotaWindows: "Quota windows", staleCount: "{{count}} stale account(s)", fresh: "Fresh", windowTypes: "5 hour, 7 day, and additional windows",
          todayTokens: "Today's tokens", input: "Input", output: "Output", cacheRead: "Cache read", cacheWrite: "Cache write", estimatedCost: "Estimated cost", costDisclaimer: "Public API equivalent estimate",
          trend: "Daily trend", tokens: "Tokens", cost: "Cost", emptyTrend: "No requests in this period.",
        },
        accounts: {
          ...
          createApiKeyTitle: "Add API Key account", createOAuthTitle: "Add OAuth account", editApiKeyTitle: "Edit API Key account", editOAuthTitle: "Edit OAuth account",
          oauthUnavailableTitle: "OAuth enrollment unavailable", oauthUnavailableDescription: "OAuth enrollment remains release-blocked until an official third-party contract is available. No account or credential will be created.", returnToPool: "Return to account pool",
          enabledField: "Account enabled",
          oauth: { loopback: "Browser OAuth", manual: "Manual callback", device_code: "Device Code" },
        ...
        keys: {
          ...
          createHint: "Choose a display group and routing permissions. The plaintext is returned once after creation.", editTitle: "Edit gateway key", editHint: "Update metadata and permissions. Key material cannot be edited.",
          displayGroup: "Display group", routeGroupPermissions: "Allowed routing account groups", groupTabsLabel: "Gateway key display groups", manageGroups: "Manage display groups", manageGroupsHint: "Display groups organize this table and are separate from routing permissions.", newGroupName: "New display group name", renameGroup: "Rename display group", deleteGroup: "Delete display group", deleteGroupConfirm: "Delete {{name}}? Its keys will move to the default display group.", defaultGroupHint: "The default display group cannot be renamed or deleted.", customGroupHint: "Keys in this display group appear in its tab.", noGroups: "No display group is available.",
          search: "Search gateway keys", searchPlaceholder: "Search name or masked key...", statusFilter: "Key status", sortLabel: "Sort keys", emptyFiltered: "No gateway keys match these filters.",
          nameColumn: "Name", apiKeyColumn: "API key", usage: "Usage", status: "Status", actions: "Actions", edit: "Edit", delete: "Delete", deleteConfirm: "Delete {{name}}? The key will stop working immediately.",
          statuses: { all: "All statuses", active: "Active", disabled: "Disabled", expired: "Expired" },
          sorts: { createdNewest: "Newest created", createdOldest: "Oldest created", nameAscending: "Name A-Z", nameDescending: "Name Z-A" },
          convert: "Convert to providers", convertTitle: "Convert gateway key", convertHint: "Create providers for {{name}} in selected tools.", converted: "Converted", activateProviders: "Activate created providers", tools: { claude: "Claude", codex: "Codex", gemini: "Gemini", opencode: "OpenCode" },
          pageSummary: "Page {{page}} · {{total}} keys", previous: "Previous", next: "Next",
        },
        logs: {
          ...
          time: "Time", model: "Model", account: "Account", group: "Group", upstreamModel: "Upstream model", apiKey: "API key", status: "Status", errorCode: "Error code", startDate: "Start date", endDate: "End date", allAccounts: "All accounts", allGroups: "All groups", allApiKeys: "All API keys", pageSize: "Page size", tokens: "Tokens", cost: "Cost", noError: "No error", noAttempts: "No upstream attempts recorded.",
          streamStarted: "client bytes emitted", previous: "Previous page", next: "Next page",
        },
        settings: {
  ...
  zh: {
    translation: {
      ...
      aiRoutingGateway: {
        ...
        common: {
          loading: "正在加载网关数据...", loadFailed: "无法加载网关数据", retry: "重试", refresh: "刷新",
          empty: "暂无网关数据。", save: "保存", create: "创建", cancel: "取消", close: "关闭", copy: "复制",
          start: "启动网关", stop: "停止网关", enabled: "已启用", disabled: "已禁用", add: "添加", notCalculable: "不可计算",
          days: "天", daysSuffix: "天",
        },
        states: {
          running: "运行中", stopped: "已停止", error: "错误", locked: "凭据存储已锁定",
          stoppedHint: "网关当前不接收请求。", portConflict: "端口冲突",
          portConflictHint: "端口 {{port}} 不可用，请在设置中更换端口后重新启动。",
        },
        errors: {
        ...
        home: {
          accounts: "账号容量", available: "可参与路由", quotaWindows: "额度窗口", staleCount: "{{count}} 个账号额度已过期", fresh: "数据新鲜", windowTypes: "5 小时、7 日及附加窗口",
          todayTokens: "今日 Token", input: "输入", output: "输出", cacheRead: "缓存读取", cacheWrite: "缓存写入", estimatedCost: "预估费用", costDisclaimer: "公开 API 单价等效预估",
          trend: "每日趋势", tokens: "Token", cost: "费用", emptyTrend: "该时段暂无请求。",
        },
        accounts: {
          ...
          createApiKeyTitle: "添加 API Key 账号", createOAuthTitle: "添加 OAuth 账号", editApiKeyTitle: "编辑 API Key 账号", editOAuthTitle: "编辑 OAuth 账号",
          oauthUnavailableTitle: "OAuth 录入暂不可用", oauthUnavailableDescription: "在官方第三方契约可用前，OAuth 录入仍受发布门禁限制，不会创建账号或凭据。", returnToPool: "返回账号池",
          enabledField: "启用账号",
          oauth: { loopback: "浏览器 OAuth", manual: "手动回调", device_code: "设备代码" },
        ...
        keys: {
          ...
          createHint: "选择展示分组与路由权限；创建后仅返回一次明文。", editTitle: "编辑网关密钥", editHint: "更新元数据与权限，密钥材料不可编辑。",
          displayGroup: "展示分组", routeGroupPermissions: "允许的路由账号分组", groupTabsLabel: "网关密钥展示分组", manageGroups: "管理展示分组", manageGroupsHint: "展示分组仅组织当前表格，与路由授权分组相互独立。", newGroupName: "新展示分组名称", renameGroup: "重命名展示分组", deleteGroup: "删除展示分组", deleteGroupConfirm: "删除 {{name}}？其中密钥将迁移到默认展示分组。", defaultGroupHint: "默认展示分组不可重命名或删除。", customGroupHint: "该展示分组的密钥显示在对应标签页。", noGroups: "暂无可用展示分组。",
          search: "搜索网关密钥", searchPlaceholder: "搜索名称或脱敏密钥...", statusFilter: "密钥状态", sortLabel: "密钥排序", emptyFiltered: "没有符合当前筛选条件的网关密钥。",
          nameColumn: "名称", apiKeyColumn: "API 密钥", usage: "用量", status: "状态", actions: "操作", edit: "编辑", delete: "删除", deleteConfirm: "删除 {{name}}？该密钥会立即失效。",
          statuses: { all: "全部状态", active: "活跃", disabled: "已停用", expired: "已过期" },
          sorts: { createdNewest: "创建时间从新到旧", createdOldest: "创建时间从旧到新", nameAscending: "名称升序", nameDescending: "名称降序" },
          convert: "转换为服务商", convertTitle: "转换网关密钥", convertHint: "为 {{name}} 在所选工具中创建服务商。", converted: "已转换", activateProviders: "激活新建服务商", tools: { claude: "Claude", codex: "Codex", gemini: "Gemini", opencode: "OpenCode" },
          pageSummary: "第 {{page}} 页，共 {{total}} 个密钥", previous: "上一页", next: "下一页",
        },
        logs: {
          allStatuses: "全部状态", clear: "清空明细", clearConfirm: "清空全部请求和 attempt 明细？每日聚合会保留。", empty: "没有符合筛选条件的请求日志。",
          time: "时间", model: "模型", account: "账号", group: "分组", upstreamModel: "上游模型", apiKey: "Key", status: "状态", errorCode: "错误码", startDate: "开始日期", endDate: "结束日期", allAccounts: "全部账号", allGroups: "全部分组", allApiKeys: "全部 Key", pageSize: "每页条数", tokens: "Token", cost: "费用", noError: "无错误", noAttempts: "没有记录上游 attempt。",
          streamStarted: "已向客户端输出字节", previous: "上一页", next: "下一页",
        },
        settings: {
